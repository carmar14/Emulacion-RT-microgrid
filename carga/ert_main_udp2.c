//compile using "gcc ert_main_udp2.c carga_sf.c rt_nonfinite.c rtGetInf.c rtGetNaN.c libmcp3204.c -lm -lwiringPi -lrt -Wall"
...
#define PORTR 8896			//Puerto Remoto I3
