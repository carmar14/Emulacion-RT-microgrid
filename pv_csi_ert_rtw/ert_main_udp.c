// compile with "gcc ert_main_udp.c pv_csi.c pv_csi_data.c rt_nonfinite.c rtGetInf.c rtGetNaN.c libmcp3204.c  -lm -lwiringPi -lrt -Wall -lpthread
...
#define PORTR1 8886			//Puerto Remoto I2
#define PORTR2 8885			//Puerto Remoto Ddie
