// compile with "gcc ert_main_OPC_Pipes.c pv_csi.c pv_csi_data.c rt_nonfinite.c rtGetInf.c rtGetNaN.c libmcp3204.c  -lm -lwiringPi -lrt -Wall -lpthread
