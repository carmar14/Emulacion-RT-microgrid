...
#include "BIO_csi_sf_smpc_v2.h"        /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
    ...
    /* Check for overrun */
    if (OverrunFlag) {
        rtmSetErrorStatus(BIO_csi_sf_smpc_v2_M, "Overrun");
        return;
    }
...
int_T main(int_T argc, const char *argv[])
{
     ...
     *  simulate model behavior at stop time.
     */
    while ((rtmGetErrorStatus(BIO_csi_sf_smpc_v2_M) == (NULL)) &&
            !rtmGetStopRequested(BIO_csi_sf_smpc_v2_M)) {
